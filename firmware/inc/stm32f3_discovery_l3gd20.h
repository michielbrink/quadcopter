...
/**
  * Definitions on how many degrees per second [dps] the LSB is
  */
#define L3GD20_Rot_Sensitivity_250         ((float) 0.00875)
#define L3GD20_Rot_Sensitivity_500         ((float) 0.0175)
#define L3GD20_Rot_Sensitivity_2000        ((float) 0.070)
...
/*
 * @defgroup sensitivity scaling factors
 */
#define L3GD20_Acc_Sensitivity_2g     (float)     1.0f    /*!< accelerometer sensitivity with 2 g full scale [LSB/mg] */
#define L3GD20_Acc_Sensitivity_4g     (float)     0.5f    /*!< accelerometer sensitivity with 4 g full scale [LSB/mg] */
#define L3GD20_Acc_Sensitivity_8g     (float)     0.25f   /*!< accelerometer sensitivity with 8 g full scale [LSB/mg] */
#define L3GD20_Acc_Sensitivity_16g    (float)     0.0834f /*!< accelerometer sensitivity with 12 g full scale [LSB/mg] */
