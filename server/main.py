...
while 1:
    ...
    m1 = stm_message(0x02, [pack('>H', c0x02_list[0])[:1],pack('>H', c0x02_list[1])[1:],pack('>H', c0x02_list[2])[:1],pack('>H', c0x02_list[3])[1:],pack('>H', c0x02_list[4])[:1],pack('>H', c0x02_list[5])[1:],pack('>H', c0x02_list[6])[:1],pack('>H', c0x02_list[7])[1:]])
